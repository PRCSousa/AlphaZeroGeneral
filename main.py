...
if __name__ == '__main__':
    ...
    if GAME == 'Go':
        args = {
            ...
            'num_epochs': 1000,                  # number of epochs for training on self-play data for each iteration
        ...
        args = {
            ...
            'max_moves': 500,                  # maximum number of moves in a game (to avoid infinite games which should not happen but just in case)
