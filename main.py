...
if __name__ == '__main__':
    ...
    if GAME == 'Go':
        args = {
            ...
            'temperature': 1.5,              # temperature for the softmax selection of moves
            'C': 2,                           # the value of the constant policy
            'augment': True,                 # whether to augment the training data with flipped states
            'dirichlet_alpha': 0.15,           # the value of the dirichlet noise
            'dirichlet_epsilon': 0.1,        # the value of the dirichlet noise
            'alias': ('Go' + SAVE_NAME)
        }
