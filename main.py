...
if __name__ == '__main__':
    ...
    if GAME == 'Go':
        args = {
            ...
            'num_mcts_searches': 800,         # number of mcts simulations when selecting a move within self-play
            ...
            'temperature': 0.5,              # temperature for the softmax selection of moves
            'C': 2,                           # the value of the constant policy
            'augment': False,                 # whether to augment the training data with flipped states
            'dirichlet_alpha': 0.2,           # the value of the dirichlet noise
